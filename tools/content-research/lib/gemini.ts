...
/** Every Gemini key you have set, in order, duplicates removed. */
...
export async function geminiJson(
  ...
  if (keys.length === 0) throw new GeminiError("No Gemini key is set (GEMINI_API_KEY), so the video cannot be watched");

...
// request; this file is the part that holds. Ported from the guards that run on the same job inside
// a working content system, so a student gets the version that has already been argued with.

/** Unicode lookalikes, stage directions, dashes and emoji out. Everything written by a model goes
    through this before it is saved or printed. */

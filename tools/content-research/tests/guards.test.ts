...
import { bannedPhrasesUsed, hookWords, HOOK_MAX_WORDS, missingCta, overpromises, sanitize, spokenWords, tooLong, unsupportedNumbers, unverifiableClaims } from "../lib/guards";
import { MAX_SHARED_OPENING, repeatedOpenings, screenHooks } from "../lib/adaptation";

...
import { bestThumbnail, instagramGuess, normalizeYoutubeVideo, parseChannelRef, parseIsoDuration, SHORT_MAX_SECONDS, uploadsPlaylistId, youtubeKind } from "../lib/youtube";
...
describe("guessing an Instagram handle from a channel description", () => {
